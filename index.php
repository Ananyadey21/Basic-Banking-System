...
<head>
  ...
  <title>GRIP-Banking System by ANANYA DEY</title>
  <style>
    * {
      font-family: Poppins;
    }
...
<header>
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/coin.jpg">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/tran.jpg">
            </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>Batch_2024 - Made by ANANYA DEY</b></h6>
    <a href="https://internship.thesparksfoundation.info/" >The Sparks Foundation</a>
  </footer>
