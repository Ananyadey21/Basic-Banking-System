...
<body>
    ...
    <div class="container-fluid">
        ...
        if (isset($_REQUEST['c_id'])) {
            $sid = $_GET['c_id'];
            $sql = "SELECT * FROM client where c_id=$sid";
    ...
    <h6 class="info"><b>2021 &copy Made By ANANYA DEY</b></h6><br>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * from client where c_id=$from";
    ...
    // constraint to check zero values
        ...
        $sql = "SELECT * from client where c_id=$to";
        $query = mysqli_query($conn, $sql);
        ...
        $sql = "UPDATE client set c_balance=$newbalance where c_id=$from";
        mysqli_query($conn, $sql);

        // adding amount to reciever's account
        $newbalance = $sql2['c_balance'] + $amount;
        $sql = "UPDATE client set c_balance=$newbalance where c_id=$to";
        mysqli_query($conn, $sql);
